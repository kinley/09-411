...
{Procedure, which will add new elements to the list.}
var
  tmp: List;
begin
  if spis1 = nil then
...
{Procedure, which will print the list.}
begin
  if spis1 = nil then
  begin
...
{Procedure, which will delete the list.}
var
  tmp: List;
begin
  while spis1 <> nil do
...
{Function, which will search for the needed element in the list.}
begin
  if spis1 <> nil then    
...
{Procedure, which will delete the needed element in the list.}
var
  tmpi: List;
begin
...
{Procedure, which will delete the needed element, according to its value.}
var
  tmp: List;
begin
  if Spis1 = nil then
