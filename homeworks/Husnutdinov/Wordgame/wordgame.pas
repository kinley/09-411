...
writeln('Enter the letters');
read(s);

writeln('Enter the word length');
read(n);
...
{Filling an array of characters from the original string}
for i := 2 to s do
...
{Find the words of right length}
...
{Совершаем сортировку выбранных слов на основе введеных букв}
